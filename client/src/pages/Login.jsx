...
const Login = () => {
  ...
  const { axios, setToken, user, navigate } = useAppContext();
  ...
  return (
    <div className="bg-gradient-to-b from-[#531B81] to-[#29184B] h-screen w-screen flex items-center justify-center">
      <Toaster />
      <form
